...
# Three imaginary standardized tests which each have a mean score of 100 and a standard deviation of 15 according to their norms
...
#the code for plotting specific areas under a normal curve in R was adapted from https://chem.libretexts.org/Bookshelves/Analytical_Chemistry/Chemometrics_Using_R_(Harvey)/06%3A_Uncertainty_of_Data/6.03%3A_Using_R_to_Model_Properties_of_a_Normal_Distribution
